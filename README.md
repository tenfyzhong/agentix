...
- Record `agent` (`codex`, `claude`, `pi`, or `omp`) and `session_id` in Task and Job frontmatter; see [task document metadata](docs/task-board.md#read-only-document-projections).
